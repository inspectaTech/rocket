  ...
  app.get('/meet/socket',function(req, res){

    console.log("running meet");
    ...
    peers.on('disconnect', (error) => {
      // ...
      console.log("[peers] disconnected",error);
    });

    peers.on('error', (error) => {
      // ...
      console.log("[peers] error",error);
    });
